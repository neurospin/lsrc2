...
latex_documents = [
  ('index', 'limesurvey.tex', u'LimeSurvey Python module Documentation',
...
man_pages = [
    ('index', 'limesurvey', u'LimeSurvey Python module Documentation',
...
texinfo_documents = [
  ('index', 'limesurvey', u'LimeSurvey Python module Documentation',
   u'Dimitri Papadopoulos', 'limesurvey', 'Python module for LimeSurvey RemoteControl 2 API.',
   'Miscellaneous'),
]
